...
// Вспомогательные функции для чтения, вывода матриц, операций
...
// Операции
int sum_matrices(int **a, int n1, int m1, int **b, int n2, int m2,
                 int ***res, int *nr, int *mr);
int mul_matrices(int **a, int n1, int m1, int **b, int n2, int m2,
                 int ***res, int *nr, int *mr);
...
int sum_matrices(int **a, int n1, int m1,
                 int **b, int n2, int m2,
                 int ***res, int *nr, int *mr)
{
    if (n1 != n2 || m1 != m2)
...
int mul_matrices(int **a, int n1, int m1,
                 int **b, int n2, int m2,
                 int ***res, int *nr, int *mr)
{
    if (m1 != n2)
